...
function Members() {
    return (
        <div className="bg-slate-900 pt-8 content-container pt-16" id="members">
            <div className="flex flex-col h-screen gap-10 lg:w-[fit-content] lg:ml-8 p-4 md:w-[fit-content] md:ml-8">
