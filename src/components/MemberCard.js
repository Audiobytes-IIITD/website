...
const MemberCard = ({ name, role, email, image }) => {
    return (
        <div className="flex items-center gap-4 bg-black-800 p-4 rounded-xl flex-wrap xs:justify-center sm:justify-center xxs:justify-center" style={{ width: "300px", height: "150px" }}>
